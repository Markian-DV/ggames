...
public class King : BasePiece
{
    ...
    {
        // Has the king moved?
        if (!mIsFirstMove || mCurrentCell.mBoardPosition.x != mOriginalPos.mBoardPosition.x || mCurrentCell.mBoardPosition.y != mOriginalPos.mBoardPosition.y)
        {
            return null;
        }
        ...
        Debug.Log(currentX + " - " + (count * direction));
        // Try and get rook
